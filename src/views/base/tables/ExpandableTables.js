                  ...
                  <CTableBody>
                    {data.KepalaKeluarga && (
                      ...
                      >
                        ...
                        <CTableDataCell>
                          {data.KepalaKeluarga.NoTelp}
                        </CTableDataCell>
                        <CTableDataCell>
                          {data.KepalaKeluarga.JenisKelamin === "P"
                            ? "Perempuan"
                            : data.KepalaKeluarga.JenisKelamin === "L"
                            ? "Laki-Laki"
                            : "Tidak Diketahui"}
                        </CTableDataCell>
                        <CTableDataCell>
                          {helper.formatDateToID(
                            data.KepalaKeluarga.TanggalLahir,
                            "DD-MM-YYYY"
                          )}
                        </CTableDataCell>
                        <CTableDataCell>
                          {data.KepalaKeluarga.Keterangan}
                        </CTableDataCell>
                        <CTableDataCell>
                          {data.KepalaKeluarga.Status}
                        </CTableDataCell>
                      </CTableRow>
                    )}
