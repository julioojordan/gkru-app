...
const PaginationTable = React.lazy(() => import('./views/base/tables/PaginationTables'))
...
const routes = [
  ...
  { path: '/base/paginationTables', name: 'Tables', element: PaginationTable},
  ...
  { path: '/lingkungan/add', name: 'Add Lingkungan', element: AddLingkungan},
  { path: '/lingkungan/:id', name: 'Detail Lingkungan', element: LingkunganDetail},
  { path: '/user', name: 'Data User', element: User},
  { path: '/user/:id', name: 'Data User', element: UserDetail},
  { path: '/user/add', name: 'Data User', element: AddUser},
  { path: '/history', name: 'Data Kas Masuk dan Keluar', element: History},
  { path: '/history/:id', name: 'Detail History', element: HistoryDetail },
  { path: '/transaksi', name: 'Form Transaksi', element: Transaksi },
  { path: '/wilayah/:id', name: 'Detail Wilayah', element: WilayahDetail },
  { path: '/wilayah/add', name: 'Add Wilayah', element: AddWilayah },
  { path: '/keluarga', name: 'Data Keluarga', element: Keluarga },
  { path: '/keluarga/add', name: 'Add Keluarga', element: AddKeluarga },
  { path: '/keluarga/:id', name: 'Data Keluarga', element: KeluargaDetail },
